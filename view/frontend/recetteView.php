		...
		<div class='flexrow'>
			...
			<div id='divAddCateg'>
				<form method="post" class="formLogin">
					...
					<p class='addCateg'></p>
					<label for="addCateg">Choisissez un titre pour votre nouvelle
						catégorie.</label> <input type="text" id="addCateg"
						name="addCateg" value="" contenteditable="true" autocomplete="off">
					<label for="selectRangNewCateg">Emplacement</label> <select
						id="selectRangNewCateg" name="selectRangNewCateg">

<?php

if (($aUserCategory != false) && (count($aUserCategory) > 0)) :
    for ($i = 0; $i <= count($aUserCategory); $i ++) :
        $rang = $i + 1;
        $place = $i + 1;
        $libel = 'Place ' . $place . '';
...
<?php endif; ?>
						...
						</select> <span id='validAddCateg' class="divAddCateg">Valider</span>
		...
		<div class='flexrow'>
			<div id='divModifCateg'>
				<form method="post">
					...
					<label for="selectModifCateg">Choisissez le nom de la catégorie à
						modifier.</label> <select id="selectModifCateg"
						name="selectModifCateg">
    <?php
...
<?php
    ...
    ?>
						...
						</select> <label for="modifCateg">Le modifier en :</label> <input
						type="text" id="modifCateg" name="modifCateg" value=""
						contenteditable="true" autocomplete="off"> <span
						id='validModifLibelCateg' class="divAddCateg">Valider</span>

<?php if(($aUserCategory!=false) && (count($aUserCategory) >1)): ?>
						<label for="selectRangModifCateg">Changer l'emplacement de la
						catégorie sélectionnée ?</label> <select
						id="selectRangModifCateg" name="selectRangModifCateg">
...
<?php endfor; ?>
						</select> <span id='validModifRangCateg' class="divAddCateg">Valider</span>
<?php endif; ?>
...
<?php
    ...
    ?>
						</select> <span id='validDelCateg' class="divAddCateg">Supprimer</span>
