...
namespace Model;
	class Shop extends ShopManager {
		...
		// **************************************************
	  	 ...
	  	 private $_id_shop;
	  	 private $_date_planning_start; //date du début du planing 
	  	 private $_date_planning_end; //date de fin du planning 
	  	 private $_list; //liste de courses 	
		 private $_recall;//date du début du rappel
