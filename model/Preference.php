...
class Preference extends PreferenceManager
{
    ...
    // mois concerné par le planing pour le calendrier
    private $_id_planning_day;

    // liste des id du planning day correspondant
    private $_people_recipe;

    // id de lutilisateur
    private $_limit_pagination;

    // nombre de recette a afficher par page
