...
class RelationUserManager extends Bdd{
	...
	// CONSTANTES
		...
		const TAB_RELATION = 'relation_user'; // nom de la table
...
//******************************************************************************************************************
	 	 ...
	 	 public function add(RelationUser $relationUser){
            ...
            $arr=array(
	 	 		array(":id_user"  , $param2),
	 	 		array(":id_friend"  , $param3),
	 	 		array(":modif_recipe"  , $param4),
	 	 		array(":modif_planning"  , $param5),
	 	 		array(":modif_shop"  , $param6));
...
//******************************************************************************************************************
	 	//actualise les relations d'un utilisateur et d'un amie
	 	 public function update($modif_recipe, $modif_planning, $modif_shop, $id_friend, $id_user){
	 	 	...
	 	 	$arr=array(
	 	 		array(":modif_recipe" , $modif_recipe),
	 	 		array(":modif_planning" , $modif_planning),
	 	 		array(":modif_shop" , $modif_shop),
	 	 		array(":id_friend" , $id_friend),
	 	 		array(":id_user" , $id_user));
