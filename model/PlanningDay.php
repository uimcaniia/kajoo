...
namespace Model;
	class PlanningDay extends PlanningDayManager {
		...
		// **************************************************
	  	 ...
	  	 private $_rang; //rang du planning dans la journée  1 : entree ; 2: plat ; 3:dessert 	
	  	 private $_id_recette; //id de la recette 
		 private $_id_planning;// id du planning correspondant 
		 private $_other;// liste des plats ou autre qui ne viennet pas d'une recette 	
		 private $_personn;// nbr de personne a manger 	
		 
		 private $_id_user;// id de l'utilisateur 
