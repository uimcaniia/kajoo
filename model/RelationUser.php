...
namespace Model;
	...
	class RelationUser extends RelationUserManager {
		...
		// **************************************************
		 ...
		 private $_id_relation_user; //  id de la relation 
	  	 private $_id_user; // id de l'utilisateur du compte 
		 private $_id_friend;  // id de l'ami pour le partage 
	  	 private $_modif_recipe; //  	autorise (1) ou non (0) la modification des recettes 
	 	 private $_modif_planning;// autorise (1) ou non (0) la modification du planning 
	 	 private $_modif_shop;//autorise (1) ou non (0) la modification de la liste des courses 	
