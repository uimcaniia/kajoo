	...
	class Category extends CategoryManager {
		...
		// **************************************************
		 ...
		 private $_id_category;
	  	 private $_rang;// 	rang de la catégorie pour l'affichage 	
		 private $_title;//libellé de la catégory 
	  	 private $_id_user ; //id user a qui appartient la catégorie 
	  	 private $_default_category ; //category par défaut : 1 sinon 0 
